...
export const WelcomeInfo = () => {
    return (
        <div className="h-screen text-center grid grid-rows-2 lg:grid-cols-2 lg:grid-rows-none overflow-hidden">
            <div className="self-center px-6 flex flex-col items-center gap-4 lg:gap-6">
                ...
                <p className="text-primary font-text max-w-[500px]">Productos de limpieza que te ayudarán a remover profundamente las sucediades acumuladas </p>
